...
var secretKey = 'maywide1234@lx100$#365#$';
var des3iv = '01234567';
var encoding = "utf-8";
...
var DES3 = {
  ...
  encrypt: function (input) {
    var genKey = genkey(secretKey, 0, 24);
    return stringToHex(des(genKey.key, input, 1, 1, des3iv, 1));
  },
  ////3DES解密，CBC/PKCS5Padding
  decrypt: function (input) {
    var genKey = genkey(secretKey, 0, 24);
    return des(genKey.key, hexToString(input), 0, 1, des3iv, 1);
  }
};
module.exports = {
